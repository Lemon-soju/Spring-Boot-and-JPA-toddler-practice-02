...
import lemonsoju_group.lemonsoju_artifact.domain.item.Book;
...
public class InitDb {
    ...
    @PostConstruct // 스프링이 시작되면 자동으로 함수 호출해줌
    public void init(){
        initService.dbInit1();
        initService.dbInit2();
    }
    ...
    static class InitService {
        ...
        private Member createMember(String name, String city, String street, String zipcode) { // Shift + F6 -> 동시에 수정
